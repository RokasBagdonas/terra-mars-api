# Generated by Django 3.1 on 2020-09-08 08:51
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddConstraint(
            model_name='playerscore',
            constraint=models.CheckConstraint(check=models.Q(corporation__in={'Thorgate', 'Celestic', 'Poseidon', 'Vitor', 'Mining Guild', 'Polyphemos', 'Helion', 'Terractor', 'Arklight', 'United Nations Mars Initiative', 'Inventrix', 'Aphrodite', 'Aridor', 'Ecoline', 'Credicor', 'Valley Trust', 'Point Luna', 'Storm Craft Incorporated', 'Manutech', 'Tharsis Republic', 'Cheung Shing Mars', 'Interplanetary Cinematics', 'Viron', 'Robinson Industries', 'Morning Star Inc.', 'Saturn Systems', 'Phobolog'}), name='Only defined corporations are allowed.'),
        ),
    ]
